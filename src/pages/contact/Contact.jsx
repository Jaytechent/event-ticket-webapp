    ...
    <div>
      ...
      <div className="mt-10 p-5 flex flex-col md:flex-row max-w-5xl mx-auto text-black ">
        <div className=" md:w-1/2">
          ...
          <hr className="w-32 " />
          <h2 className="text-2xl font-semibold">+234 8131069327</h2>
          <p className="text-base mb-3">Book online or call</p>
          <h2 className="text-2xl font-semibold">olemilek100@gmail.com</h2>
          ...
          <form onSubmit={handleSubmit} className="">
            <div>
              ...
              <input
                ...
                placeholder="olemilek100@gmail.com"
                required
              />
            </div>
            <div>
