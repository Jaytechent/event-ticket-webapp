...
const TopBar = () => {
    return (
        ...
        <div className="to-blue-300 bg-primary py-2 overflow-hidden">
            <div className="flex justify-between max-w-7xl px-4 md:px-8 lg:px-12 mx-auto">
                <ul className="flex text-sm text-gray-200 gap-3">
                    ...
                    <li className="flex justify-center items-center gap-2">
                        ...
                        <a href="tel:+2348131069327">+2348131069327</a>
                    </li>
                    <li className="flex justify-center items-center gap-2">
                        <LuMailOpen className="inline"/>
                        <a href="mailto:olemilek100@gmail.com">olemilek100@gmail.com</a>
                    </li>
                </ul>
